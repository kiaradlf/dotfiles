...
# work around error `externally-managed-environment`
...
nix-env -i helix gh lazygit ripgrep fd any-nix-shell bat nushell fish zsh zoxide poetry tealdeer jaq jq yq parquet-tools
